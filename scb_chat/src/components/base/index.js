...
import InputCheckboxColor from './Input/InputCheckboxColor'
import InputIcon from './Input/InputIcon'

export {
    // InputBase, InputCheckbox, InputCheckboxViolet, InputCheckboxWhite, InputRadioViolet, ButtonStyle, ModalCustom, SelectCustom,
    // SelectDefault, SelectMultiple, SliderRange, Sliders, TextArea, InputCurrency, InputSlider,
    InputDatePicker, InputSearch, InputCheckboxColor, InputIcon
}